...
const About: React.FC = () => {
  ...
  const experience = [
    { years: '2021 - 2025', company: 'شركة التأمين الوطنية', position: 'محامية', duration: '4 سنوات' },
    { years: '2017 - 2018', company: 'الشركة الأردنية الفرنسية للتأمين', position: 'محامية', duration: 'سنتان' },
  ...
  const additionalExperience = [
    'العمل لدى مكتب خاص لمدة عامين (قضايا متنوعة)',
    'مديرة شركة أرض العز للقيادات الشبابية لتأهيل الشباب',
    'عضو فريق التطوير المجتمعي لدى USAID',
    'عضو بالهيئة الإدارية لمنتدى النعمة الثقافي',
  ];
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              هدفي هو تقديم حلول قانونية عملية وفعالة، مبنية على فهم عميق للقانون الأردني واحتياجات كل موكل على حدة. نسعى في مكتبنا إلى بناء علاقات طويلة الأمد مع موكلينا قائمة على الثقة والشفافية.
            </p>
          </div>
        </div>
