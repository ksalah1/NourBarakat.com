...
const Home: React.FC = () => {
  ...
  return (
    <div>
      <SEO
        title="محامية في عمان - نور بركات | 14 عام خبرة في قضايا التأمين والقانون المدني"
        description="محامي تأمين مركبات عمان، محامي تحصيل ديون عمان، محامي مراجعة عقود، قضايا إيجار عمان، محامي منازعات عمالية. المحامية نور بركات - +14 عاماً خبرة، عضو نقابة المحامين #16872. استشارة قانونية احترافية وإجراءات تحصيل ديون الأردن."
        keywords="محامي تأمين مركبات عمان، محامي تحصيل ديون عمان، قضايا إيجار عمان، محامي مراجعة عقود عمان، محامي منازعات عمالية عمان، كيف أرفع دعوى تأمين مركبة الأردن، إجراءات تحصيل ديون الأردن، حوادث سيارات محامي عمان، محامي إخلاء عقار عمان، محامية عمان، محامي الأردن، نور بركات، استشارات قانونية عمان"
