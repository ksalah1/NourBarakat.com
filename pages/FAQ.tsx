...
const FAQ: React.FC = () => {
  ...
  return (
    <div className="bg-gray-50 py-12">
      <SEO
        title="أسئلة شائعة"
        description="إجابات شاملة على الأسئلة الشائعة حول خدمات مكتب نور بركات للمحاماة في الأردن: التأمين، تحصيل الديون، العقود، قانون العمل، والإيجار. احصل على إجابات واضحة لأسئلتك القانونية."
